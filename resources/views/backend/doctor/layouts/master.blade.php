    ...
    <div class="header">
        ...
        <ul class="nav user-menu">
            ...
            <li class="nav-item dropdown has-arrow">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                    <span class="user-img"><img class="rounded-circle" src="{{asset('backend')}}/{{Auth::user()->profile->image ?? ''}}" width="31" alt="User Image"></span>
                </a>
            ...
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    <li class="{{ Request::is('doctors') ? 'active' : '' }}">
                        <a href="{{ url('doctors') }}"><i class="fe fe-home"></i> <span>Dashboard</span></a>
                    </li>
                    <li class="{{ Request::routeIs('doctor_patients') ? 'active' : '' }}">
                        <a href="{{ route('doctor_patients') }}"><i class="fe fe-user"></i> <span>Patients</span></a>
                    </li>
                    <li class="{{ Request::routeIs('doctor_appointments') ? 'active' : '' }}">
                        <a href="{{ route('doctor_appointments') }}"><i class="fe fe-layout"></i> <span>Appointments</span></a>
                    </li>
                    <li class="{{ Request::routeIs('blogs.*') ? 'active' : '' }}">
                        <a href="{{ url('blogs') }}"><i class="fa fa-list"></i> <span>Blogs</span></a>
                    </li>
                    <li class="{{ Request::routeIs('view_comments') ? 'active' : '' }}">
                        <a href="{{ route('view_comments') }}"><i class="fe fe-messanger"></i> <span>Comments</span></a>
                    </li>
                    <li class="{{ Request::routeIs('doctor_reviews') ? 'active' : '' }}">
                        <a href="{{ route('doctor_reviews') }}"><i class="fe fe-star-o"></i> <span>Reviews</span></a>
                    </li>
