        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="{{ Request::routeIs('all_doctors') ? 'active' : '' }}">
                        <a href="{{ route('all_doctors') }}"><i class="fe fe-user-plus"></i> <span>Doctors</span></a>
                    </li>
                    <li class="{{ Request::routeIs('all_patients') ? 'active' : '' }}">
                        <a href="{{ route('all_patients') }}"><i class="fe fe-user"></i> <span>Patients</span></a>
                    </li>
                    <li class="{{ Request::routeIs('appointments') ? 'active' : '' }}">
                        <a href="{{route('appointments')}}"><i class="fe fe-layout"></i> <span>Appointments</span></a>
                    </li>
                    <li class="{{ Request::routeIs('all_blogs') ? 'active' : '' }}">
                        <a href="{{route('all_blogs')}}"><i class="fa fa-list"></i> <span>Blogs</span></a>
                    </li>
                    <li class="{{ Request::is('transactions-list') ? 'active' : '' }}">
